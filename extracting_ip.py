...
{
    "nmap": {
        "command_line": "nmap -oX - -sV 10.0.21.0/24",
        "scaninfo": {
            "tcp": {
                "method": "connect",
        ...
        "scanstats": {
            "timestr": "Fri Jun 17 16:08:45 2022",
            "elapsed": "46.91",
            "uphosts": "3",
            "downhosts": "253",
            "totalhosts": "256",
    ...
    "scan": {
        "10.0.21.1": {
            "hostnames": [{"name": "WSSAP5A04A7", "type": "PTR"}],
            "addresses": {"ipv4": "10.0.21.1"},
            "vendor": {},
            ...
            "tcp": {
                53: {
                    ...
                    "extrainfo": "",
                    "conf": "10",
                    "cpe": "cpe:/a:thekelleys:dnsmasq:2.80",
                }
            },
        },
        "10.0.21.81": {
            "hostnames": [{"name": "726dec0a2749", "type": "PTR"}],
            "addresses": {"ipv4": "10.0.21.81"},
            "vendor": {},
            "status": {"state": "up", "reason": "conn-refused"},
            "tcp": {
                22: {
        ...
        "10.0.21.171": {
            "hostnames": [{"name": "somesh-HP-Pavilion-Notebook", "type": "PTR"}],
            "addresses": {"ipv4": "10.0.21.171"},
            "vendor": {},
            "status": {"state": "up", "reason": "conn-refused"},
            "tcp": {
                22: {
